	...
	do
	{
		...
		if( seq_len != 0 )
		{
			...
			if ( r )
			{
				...
				free ( rc_seq );
				#ifdef _USE_64
				fprintf( stderr, "Processing both strands of sequence %s of length %lu\n", ( char * ) seq_id, seq_len );
				#endif
				#ifdef _USE_32
			...
			{
				#ifdef _USE_64
				fprintf( stderr, "Processing 5'->3' strand of sequence %s of length %lu\n", ( char * ) seq_id, seq_len );
				#endif
				#ifdef _USE_32
